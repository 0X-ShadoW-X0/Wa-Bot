...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to Shadow voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional Shadow features. Turn your account into a ai chatbot!'
    already_on = 'Shadow artificial intelligence is already fully functional.'
    already_off = 'Shadow artificial intelligence is currently running semi-functional.'
    succ_on = 'Shadow Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'Shadow Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'AZ') {
