...
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/trance.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.DURATION, contextInfo: { forwardingScore: 1000, isForwarded: true }, quoted : message.data, ptt: true})
        }
        if (!!message.mention && message.mention[0] == Config.AFNN) {
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/Mention.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.DURATION, contextInfo: { forwardingScore: 1000, isForwarded: true }, quoted : message.data, ptt: true})
        }
...
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.DURATION, contextInfo: { forwardingScore: 1000, isForwarded: true }, quoted: message.data, ptt: true})
}
});
    }
...
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./upload/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.DURATION, contextInfo: { forwardingScore: 1000, isForwarded: true }, quoted: message.data, ptt: true})
}
});
    }
...
await message.client.sendMessage(message.jid, fs.readFileSync('./stickers/mention.webp'), MessageType.sticker, { mimetype: Mimetype.webp,contextInfo: { forwardingScore: 1000, isForwarded: true }, quoted : message.data, ptt: false})
    }
