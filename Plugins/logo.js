...
Asena.addCommand({pattern: 'silk ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '```Battle logo Effect```'})
    ...
    Asena.addCommand({pattern: '2fire ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
  ...
  await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '```Shadow effect```'})
    ...
    Asena.addCommand({pattern: 'skytext ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
    ...
    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '```Water color By Shadow```'})
    ...
    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '```glow Image By Shadow ```'})
    ...
    Asena.addCommand({ pattern: '2ttp ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: '2attp ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
