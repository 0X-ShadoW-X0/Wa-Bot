...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'SHADOW BOT' : process.env.ALL_CAPTION,
    ...
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Hello Guys' : process.env.TAG_HEADER,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    MAHN: process.env.MAAN === undefined ? '919526808481,0' : process.env.MAAN,
    BRANCH: 'master',
    HEROKU: {
